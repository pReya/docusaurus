...
Markdown can embed HTML elements, and [`details`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/details) HTML elements are automatically beautifully styled.
...
Alternatively, if you don't like this long-ish HTML syntax for your `details` elements, you can also use the ready-made React component from the `@docusaurus/theme-common` package, which is always available, when you're using an official Docusaurus theme.

```md
### Details element React component example
